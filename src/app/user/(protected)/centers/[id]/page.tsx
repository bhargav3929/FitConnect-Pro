...
export default function CenterDetailPage() {
    ...
    return (
        <div className="pb-24 bg-[#0B0F19] min-h-screen">
            <SpotSelectionModal
            ...
            <div className="relative h-[40vh] min-h-[300px] overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0B0F19]/50 to-[#0B0F19] z-10" />
                ...
                <div className="absolute top-0 left-0 right-0 p-6 z-20 flex justify-between items-center">
                    <Link href="/user/centers" className="w-10 h-10 rounded-full bg-[#F0F2F5]/10 backdrop-blur-md flex items-center justify-center text-white hover:bg-[#F0F2F5]/20 transition-all">
                        <ChevronLeft className="w-5 h-5" />
                    </Link>
                    <div className="flex gap-3">
                        <button className="w-10 h-10 rounded-full bg-[#F0F2F5]/10 backdrop-blur-md flex items-center justify-center text-white hover:bg-[#F0F2F5]/20 transition-all">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <div className="flex items-center gap-1 text-[#F59E0B]">
                                ...
                                <span className="text-[#5A6478] text-xs">({CENTER_DATA.reviewCount})</span>
                            </div>
                        </div>
            ...
            {/* Floating Tabs */}
            <div className="sticky top-0 z-30 bg-[#0B0F19]/80 backdrop-blur-xl border-b border-[#1A2238] px-6 py-4 overflow-x-auto">
                            ...
                            <div className="bg-[#F0F2F5]/5 rounded-2xl p-6 border border-[#1A2238]">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm text-[#F0F2F5]/80">{CENTER_DATA.contact.phone}</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-lg bg-[#FF6A3D]/20 flex items-center justify-center text-[#FF6A3D]">
                                            <Mail className="w-4 h-4" />
                                        </div>
                                        <span className="text-sm text-[#F0F2F5]/80">{CENTER_DATA.contact.email}</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-lg bg-[#FF6A3D]/20 flex items-center justify-center text-[#FF6A3D]">
                                        ...
                                        <div className="flex flex-col text-sm">
                                            <span className="text-[#F0F2F5]/80">Mon-Fri: {CENTER_DATA.hours.weekday}</span>
                                            <span className="text-[#F0F2F5]/80">Sat-Sun: {CENTER_DATA.hours.weekend}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>

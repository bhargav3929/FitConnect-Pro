        ...
        <div className="min-h-screen bg-peach-200 py-32 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 text-olive-600 uppercase font-display">
                        Invest In Yourself
                    </h1>
                    <p className="text-xl text-olive-300 max-w-2xl mx-auto">

...
export default function SubscriptionPage() {
    return (
        <div className="min-h-screen bg-warmDark-800 py-32 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 text-peach-200 uppercase font-display">
                        Invest In Yourself
                    </h1>
                    <p className="text-xl text-peach-400 max-w-2xl mx-auto">
                ...
                <div className="mt-20 text-center border-t border-peach-400/10 pt-10">

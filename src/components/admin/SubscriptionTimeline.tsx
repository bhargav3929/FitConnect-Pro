...
const ACTION_LABEL: Record<SubscriptionEventAction, string> = {
    ...
    'plan-unfrozen': 'Freeze ended',
    'plan-adjusted': 'Adjusted by admin',
    'cancel-scheduled': 'Cancel after next charge',
...
const ACTION_TONE: Record<SubscriptionEventAction, string> = {
    ...
    'plan-frozen': 'bg-blue-500/10 text-blue-700 ring-1 ring-blue-500/20',
    'plan-unfrozen': 'bg-blue-500/10 text-blue-700 ring-1 ring-blue-500/20',
    'plan-adjusted': 'bg-amber-500/10 text-amber-700 ring-1 ring-amber-500/20',
    'cancel-scheduled': 'bg-peach-300/40 text-olive-500 ring-1 ring-olive-400/15',

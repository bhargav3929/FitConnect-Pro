...
>(
    (
        ...
        // const { resolvedTheme } = useTheme(); // Comment out theme usage to avoid complexity if provider missing
        // const overlayThemeClass = resolvedTheme === 'dark' ? 'light' : 'dark';
        const overlayThemeClass = 'light'; // Force light overlay for contrast in dark theme
